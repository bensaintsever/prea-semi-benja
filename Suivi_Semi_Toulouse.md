...
| **Vigilance n°2** | **Hanche droite latérale.** Deuxième épisode le 29/08 (deux jours après le premier), sur du dénivelé non prévu et à cadence basse, effort pourtant facile en FC. **Motif de suivi actif depuis le 29/08**, sortie longue du 30/08 annulée. Piste retenue : dénivelé et cadence, pas l'intensité (voir section dédiée) |
...
| **29/08** | **Deuxième épisode de gêne hanche droite**, sur un footing facile en FC (121) mais avec du dénivelé non prévu à Bazas et cadence basse (168). Le déclencheur posé le 27/08 s'active : ce n'est plus un épisode isolé. **Sortie longue du 30/08 annulée** par Benjamin, décision cohérente avec la règle de tri. Aucun changement structurel au plan au-delà de ça pour l'instant, piste retenue = dénivelé/cadence plutôt qu'intensité |
...
**Ce que ça exclut et ce que ça pointe** : la FC basse (121) élimine l'intensité comme facteur. Les deux occurrences partagent en revanche un point commun : le 27/08 était une séance dure (autre variable), mais le 29/08 était facile en effort ET sur du dénivelé non planifié, à cadence basse. Le dénivelé (montées-descentes) charge excentriquement les stabilisateurs de hanche (moyen fessier) d'une façon différente du plat — hypothèse à retenir en priorité : **le dénivelé et/ou la cadence basse, pas l'intensité**, sont les vrais déclencheurs candidats pour ce côté-là.
...
**Prochaine décision si ça continue** : si un troisième épisode survient dans les prochains jours, y compris sur du plat à cadence correcte, remonter le niveau d'alerte (envisager un avis kiné plutôt que la seule surveillance). Si au contraire ça reste circonscrit aux terrains avec dénivelé et à la cadence basse, la piste "dénivelé + cadence" devient la lecture retenue et la vigilance se concentre sur ces deux variables plutôt que sur l'intensité.
...
| **29/08** | Footing à Bazas | 6,24 km | 6'26 | 121 | Effort réellement facile (FC 121), mais **+76 m / -81 m de dénivelé sur 6,24 km**, non prévu (séjour annoncé plat). Cadence 168, pas la cible corrigée de 176. **Deuxième épisode de gêne à la hanche droite**, deux jours après le premier : le déclencheur posé le 27/08 s'active, voir section dédiée. **Sortie longue du 30/08 annulée** par décision de Benjamin |
