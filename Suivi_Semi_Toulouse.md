...
| **Où on en est** | **S6, première semaine de phase 2 (seuil)**, démarrée le 24/08. **Première séance de seuil réalisée le 27/08** (3 × 8'), le bloc tient |
...
| 27/08 | **Première séance de seuil de la phase 2 réalisée** (3 × 8'). Allure dure à caler sur le premier bloc, convergence au troisième : conforme à sa signature de pacing, pas un problème. **Nouvelle gêne hanche droite latérale** en toute fin, isolée : surveillance sans changement de plan, voir la section dédiée |
...
| **27/08** | **Seuil 3 × 8', première de la phase 2** (+ épaule-bras) | — | — | — | Séance complète, 3 blocs (cible 4'42-4'50, FC 155-163). **Allure dure à caler, 3e bloc le plus concluant** : même signature de négatif-split qu'au contre-la-montre du 13/08. **Gêne à la hanche droite latérale en toute fin.** Splits et FC réels à confirmer via COROS (connecteur indisponible ce jour) |
